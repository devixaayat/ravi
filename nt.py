...
def lines():
    print('\u001b[37m' + '[✓] ◆𖣘︎☬☬☬☬☬☬☬☬☬☬☬【 𝗥𝗼𝗺𝗶𝗶𝐓𝐎𝐎𝐋 𝐎𝐖𝐍𝐀𝐑】☬☬☬☬☬☬☬☬☬☬☬𖣘︎◆')

def lines2():
    print('\u001b[37m' + '[[✓]] ︻╦デ╤━╼●▬▬▬▬๑۩𝗥𝗲𝗯𝗲𝗹࿋ོ༙☬●─────𖣘︎─────●☬࿋ོ༙𝗥𝘂𝗹𝗲𝘅 ۩๑▬▬▬▬▬●╾━╤デ╦︻')
...
def read_cookie():
    try:
        ...
        print("𝗖𝗵𝗲𝗮𝗸 𝗙𝗶𝗹𝗲 𝗮𝗻𝗱 𝗧𝗿𝘆 𝗔𝗴𝗮𝗶𝗻")
        return None
            ...
            while True:
                try:
                    ...
                    if 'id' in response2:
                        ...
                        print("\033[1;36mComment sent successfully✫●▬▬▬▬๑۩𒊹︻╦デ╤━╼𝗥𝗼𝗺𝗶𝗶 𝐓𝐎𝐎𝐋╾━╤デ╦︻𒊹︎۩๑▬▬▬▬▬●✫ ::", comment_with_name)
                        lines2()
                        x = (x + 1) % len(comments)
